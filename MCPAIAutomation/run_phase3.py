...
from src.delivery.client import generate_markdown_report, generate_email_teaser
...
def main():
    print("======================================================================")
    print("Running Phase 3 Delivery Pipeline (Clustering -> Report & Teaser)")
    print("======================================================================\n")
    ...
    try:
        ...
        # 2. Generate Email Teaser
        print("Generating Email Teaser...")
        doc_id = "mock_google_doc_id_12345"
        ...
        report_path = reports_dir / f"weekly_report_groww_{iso_week}.md"
        email_path = emails_dir / f"email_teaser_groww_{iso_week}.json"
        email_html_path = emails_dir / f"email_teaser_groww_{iso_week}.html"
        ...
        print(f"Saved Email Teaser JSON to {email_path}")
        
        with open(email_html_path, "w", encoding="utf-8") as f:
            f.write(email_teaser["html_body"])
        print(f"Saved Email Teaser HTML to {email_html_path}")
        ...
        print("======================================================================")
        print("Email Teaser Preview:")
        print("======================================================================\n")
        print(f"Subject: {email_teaser['subject']}\n")
        print(email_teaser['text_body'])
        print("======================================================================")
