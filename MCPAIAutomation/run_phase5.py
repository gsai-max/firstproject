...
def main():
    print("======================================================================")
    print("Running Phase 5 Delivery Pipeline (Doc Append + Gmail Draft Delivery)")
    print("======================================================================\n")
    ...
    try:
        ...
        print(f"Doc Delivery Result Status: {doc_res.get('status')}")

        # 3. Generate Email Teaser (deep link Doc URL)
        print("\nGenerating Email Teaser...")
        # Check if doc_res returned the real doc ID (e.g. from success response)
        actual_doc_id = doc_id
        if doc_res.get("status") == "success" and "response" in doc_res:
            actual_doc_id = doc_res["response"].get("documentId", doc_id)
        ...
        print(f"Attempting Gmail Draft Delivery (To: {recipients})...")
        ...
        print("======================================================================\n")
        print("Google Doc Append:")
        print(json.dumps(doc_res, indent=2))
        print("\nGmail Draft Create:")
        print(json.dumps(gmail_res, indent=2))
        print("======================================================================")
